...
$reviewDescription = $_POST['description'];
$hotelID = $_POST['id'];
$userID= $_SESSION['user_id'];


$sql = "INSERT INTO reviews (hotelId,userId,review, rating, datePosted) 
            VALUES ('$hotelID',$userID,'$reviewDescription',$reviewRating,CURRENT_DATE())";
